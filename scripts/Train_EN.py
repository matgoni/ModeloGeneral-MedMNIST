...
def construir_modelo(total_clases: int, usar_pesos_imagenet: bool) -> nn.Module:
    """Inicializa EfficientNet-B0 ajustando la última capa al número total de clases."""
...
def parsear_argumentos() -> argparse.Namespace:
    ...
    description="Entrena una EfficientNet-B0 como modelo general para MedMNIST."
    )
    parser.add_argument(
        "--datasets",
        nargs="+",
    ...
    "--salida",
    type=Path,
    default=Path("resultados") / "reporte_efficientnet_general.json",
